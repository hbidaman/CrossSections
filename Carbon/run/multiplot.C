...
TGraphErrors * graph1 = new TGraphErrors("CrossSections.txt", "%lg %lg %lg"); //X, Y, Yerr
...
TGraphErrors * graph2 = new TGraphErrors("ElasticCrossSection.txt", "%lg %lg %lg"); //X, Y, Yerr
...
TGraphErrors * graph3 = new TGraphErrors("InElasticCrossSection.txt", "%lg %lg %lg"); //X, Y, Yerr
...
legend->AddEntry(graph6, "ENDF Inelastic", "l");
//legend->SetLegendTextSize(0.4);
//leg.DrawClone("Same");
//legend->Draw();
//myCanvas->BuildLegend();
 // MG->Draw("apl1");  
    myCanvas->Print("multi.pdf");
